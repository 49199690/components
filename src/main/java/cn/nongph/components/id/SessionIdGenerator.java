 ...
 */
public class SessionIdGenerator extends AbstractStringGenerator implements Serializable {
    ...
    public long maxLength() {
        return RANDOM_LENGTH + TIME_LENGTH
            + AbstractStringGenerator.MAX_INT_ALPHANUMERIC_VALUE_LENGTH;
    }
    ...
    public String nextStringIdentifier() {
        ...
        StringBuffer id = new StringBuffer
            (AbstractStringGenerator.DEFAULT_ALPHANUMERIC_IDENTIFIER_SIZE);
        id.append(Long.toString(currentRandom,
            AbstractStringGenerator.ALPHA_NUMERIC_CHARSET_SIZE).substring(1));  // 6 chars
        id.append(Long.toString(currentTimeValue,
            AbstractStringGenerator.ALPHA_NUMERIC_CHARSET_SIZE).substring(1));  // 3 chars
        id.append(Long.toString(currentCount,
            AbstractStringGenerator.ALPHA_NUMERIC_CHARSET_SIZE));  // 1+ chars
        return id.toString();
    }
}
