 ...
 * @version $Id: AbstractStringIdentifierGenerator.java 480488 2006-11-29
 *          08:57:26Z bayard $
 */
public abstract class AbstractStringGenerator implements IdentifierGenerator {
	 ...
	 */
	protected static final int MAX_LONG_NUMERIC_VALUE_LENGTH = Long.toString(
			Long.MIN_VALUE).length();
	 ...
	 */
	protected static final int MAX_INT_NUMERIC_VALUE_LENGTH = Integer.toString(
			Integer.MIN_VALUE).length();
	 ...
	 * Implementations with bounded length identifiers should override this
	 * method to return the maximum length of a generated identifier.
	 * </p>
	 * 
	 * @return {@inheritDoc}
	 */
	...
	/**
	 * Returns the minimum length (number of characters) for an identifier from
	 * this sequence.
	 * 
	 * <p>
	 * The default implementation returns 0. Implementations with identifiers
	 * having a postive minimum length should override this method to return the
